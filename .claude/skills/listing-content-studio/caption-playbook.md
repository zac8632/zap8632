...
- Uses the 9:16 creative. Minimal on-image text (headline + price already on the
  creative). Optional: a "Just Listed" sticker vibe, a poll/question sticker, or
  "DM to view" text. Keep clear of the top ~250 px / bottom ~320 px UI zones.
- No external link/number on the story image (link stickers only if the account
  is eligible — otherwise soft CTA "DM us").
